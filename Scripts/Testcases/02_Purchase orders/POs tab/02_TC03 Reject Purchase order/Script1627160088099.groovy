...
//Click on Reject btn
WebUI.click(findTestObject('POs/Buttons/OrderRejectBtn'))

//Assertion on confirmation Msg
WebUI.callTestCase(findTestCase('Assertion/AssertOnRejectConfitmationMsg'), null, FailureHandling.STOP_ON_FAILURE)
